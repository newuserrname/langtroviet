...
<body>
    ...
    <table align="center" class="table" style="width: 50%;" style="font-size:18px">
        ...
        <tr class="table">
            ...
            <td class="table">145</td>
            <td class="table">123</td>
            <td class="table">12</td>
            <td class="table" align="right">66.000</td>
        </tr>
        <tr class="table">
            <td class="table">2</td>
            ...
            <td class="table">1</td>
            <td class="table" align="right">18.000</td>
        </tr>
        <tr class="table">
            <td class="table">3</td>
        ...
        <tr class="table">
            ...
            <td class="table" align="right" colspan="4">100.000</td>
        </tr>
        <tr class="table">
            <td class="table">5</td>
        ...
        <tr class="table">
            ...
            <td class="table" align="right" colspan="4">50.000</td>
        </tr>
        <tr class="table">
            <td class="table">7</td>
            <td class="table">Tổng cộng</td>
            <td class="table" align="right" colspan="4">234.000</td>
        </tr>
    </table>
    <table align="center">
        <tr>
