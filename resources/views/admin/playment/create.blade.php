...
<div class="content-wrapper">
	<div class="breadcrumb-line">
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item"><a href="{{ route('hoadon.index') }}">Hoán đơn</a></li>
          <li class="breadcrumb-item active" aria-current="page">Nhập hóa đơn</li>
        </ol>
	</div>
<!-- /page header -->
<div class="col-md-12 col-sm-12 ">
  <div class="x_panel">
      <div class="x_title">
          <h2>Thêm mới hóa đơn của bạn tại đây</h2>
          @if(session('thongbao'))
