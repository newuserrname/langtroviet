...
class NuocController extends Controller
{
    ...
    public function store(Request $request, $id)
    {
        ...
        return redirect('admin/nuoctro')->with('thongbao', 'Nhập số nước cho khách của '.$gethopdong->phongchothue->phongtro->tenphong. ' thành công!');
    }
